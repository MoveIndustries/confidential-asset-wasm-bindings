# Movement Confidential Asset WASM Bindings

WebAssembly bindings for Movement confidential asset cryptographic operations.
...
```bash
cd movement-confidential-asset-wasm-bindings
